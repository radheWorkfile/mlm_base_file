...
<div class="row">
    ...
    <div class="col-sm-5">
        ...
        <div class="input-group">
            ...
            <input type="text" value="<?php echo set_value('userid') ?>" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')" class="form-control" id="userid" placeholder="1001" name="userid">
        </div>
