...
<div class="col-sm-6">
    ...
    <?php echo ($data->add_proof) ? "Uploaded Document&nbsp;<a href=" . base_url() ."Uploads/".$data->add_proof. " target='_blank'>click Here</a>":"";?>

</div>
<div class="col-sm-6">
    <label>ID Proof</label>
    <input type="file" class="form-control" name="id_proof">
    <?php echo ($data->id_proof) ? "Uploaded Document&nbsp;<a href=" . base_url() ."Uploads/".$data->id_proof. " target='_blank'>click Here</a>":"";?>
</div>
<div class="col-sm-6">
