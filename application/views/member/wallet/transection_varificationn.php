 ...
 **************************************************************************************************/
?>
<form action="<?php echo base_url() ?>wallet/verifyy" method="post">
    <div class="col-sm-7 col-md-offset-2" style="text-align: center">
        ...
        <input type="hidden" name="balance"  value="<?php echo $tran_data['balance']; ?>"><br /><br>
        <input type="hidden" name="transfer_id"  value="<?php echo $tran_data['transefer_id']; ?>"><br /><br>
