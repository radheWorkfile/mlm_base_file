         ...
         <div class="container">
           <div class="header-top-area">
            <div class="header-top-item">
                <a href="Mailto:demo@email.com"><i
                        class="fa fa-envelope"></i><span>camwelsolution@gmail.com</span>
                    </a>
            </div>
            <div class="header-top-item">
                <a href="tel:9028388889"><i
                class="fa fa-mobile-alt"></i>91+ 9028388889 / 9572852742</a>
            </div>
                ...
                <div class="header-area">
                    <div class="logo">
                        <a href="javaScript:void(0);"><img
                                src="<?php echo base_url();?>assets/img/icon/Website_Logo.png" alt="logo"></a>
                    </div>
                    <ul class="menu">
                        ...
                        <li><a href="javaScript:void(0);">Bank Details</a></li>
                        <li><a href="<?php echo base_url();?>Site/contact">Contact</a></li>

                                                    <li>
                                <a href="javascript:void(0)">Account</a>
                                <ul class="submenu">
                                    <li><a href="javaScript:void(0);"><span onclick="document.getElementById('id01').style.display='block'">Log In</span></a>
                                    </li>
